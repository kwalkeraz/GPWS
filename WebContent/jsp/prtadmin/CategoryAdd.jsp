...
%>
	...
	<meta name="Keywords" content="Global Print category add"/>
	<meta name="Description" content="Global print website add a category page" />
	<title><%= messages.getString("global_print_title") %> | <%= messages.getString("add_new_category") %></title>
	...
	<script type="text/javascript">
	 ...
	 function addCategory() {
        ...
        var logaction = "Category " + wName + " has been added";
	 ...
	 dojo.ready(function() {
     	createHiddenInput('topageid','<%= BehaviorConstants.TOPAGE %>', '7003');
        createHiddenInput('logactionid','logaction','');
        createpTag();
        createTextInput('category','category','category','64',true,'<%= messages.getString("required_info") %>','required','<%= messages.getString("field_problems") %>','^[A-Za-z0-9 _.;,()\/-]*$','');
	...
	<div id="ibm-leadspace-head" class="ibm-alternate">
		<div id="ibm-leadspace-body">
			...
			<h1><%= messages.getString("add_new_category") %></h1>
		</div>
	</div>
