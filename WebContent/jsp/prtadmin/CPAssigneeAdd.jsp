...
%>
	...
	<meta name="Keywords" content="Global Print add analyst"/>
	<meta name="Description" content="Global print website add an analyst page" />
	<title><%= messages.getString("global_print_title") %> | <%= messages.getString("cp_analyst_add") %></title>
	...
	<script type="text/javascript">
	 ...
	 function callSubmit(event){
	 	var formName = dijit.byId('ListAddForm');
		...
		if (formValid) {
			dojo.byId('priority').value = priority;
 			logaction.value = "CP Analyst " + analyst + " for " + geo + "," + country + "," + state + "," + city + "," + building + "," + floor + " has been added";
			formName.submit();
		} else {
			return false;
		}
	 ...
	 dojo.ready(function() {
     	createHiddenInput('topageid','<%= BehaviorConstants.TOPAGE %>', '1010');
	...
	<div id="ibm-leadspace-head" class="ibm-alternate">
		<div id="ibm-leadspace-body">
			...
			<h1><%= messages.getString("cp_analyst_add") %></h1>
		</div>
	</div>
