...
<fmt:setBundle basename="tools.print.translations.gpws" scope="session" />
<% 	
...
<%
	//String rootNode = (String) request.getAttribute("ROOTNODE");
	//String classAnswer = (String)request.getParameter(PrinterConstants.CLASSIFIER_ANSWER);
	//if( classAnswer == null || classAnswer.equals("null") ) classAnswer = "";
%>
