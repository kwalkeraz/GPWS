...
<header class="hero hero--small" style="background-image: url(&quot;http://w3-03.ibm.com/tools/print/images/bee_background.png&quot;);"><h1 class="hero__title">Global Print | Locate Printers</h1> <!----> 
