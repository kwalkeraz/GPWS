...
%>
	...
	<header class="hero hero--small" style="background-image: url(&quot;http://w3-03.ibm.com/tools/print/images/bee_background.png&quot;);"><h1 class="hero__title">Global Print | Search Results</h1> <!----> 
	...
	<div id="ibm-leadspace-head" >
		<div >
			<ul id="ibm-navigation-trail">
				...
				<li><a href="<%= printeruser %>?<%= BehaviorConstants.TOPAGE %>=60">Search Printers</a></li>
			</ul>
