...
%>
	...
	<meta name="Keywords" content="Global Print search device modify"/>
	<meta name="Description" content="Global print website modify device information page." />
	<title><%= messages.getString("global_print_title") %> | <%= messages.getString("device_modify_request") %></title>
	...
	<script type="text/javascript">
	 ...
	 function searchByName(deviceName) {
	 	...
	 	document.location.href="<%= commonprocess %>?<%=  BehaviorConstants.TOPAGE %>=1025" + params;
	 } //searchByName
	 ...
	 dojo.ready(function() {
	 	...
	 	createHiddenInput('nametopageid','<%= BehaviorConstants.TOPAGE %>', '1025','nametopageid');
	 	createpTag();
		...
		createGetForm('locform','geographicInfo','geographicInfo','ibm-column-form ibm-styled-form','<%= commonprocess %>');
 		createGetForm('byname','searchbyName','searchbyName','ibm-column-form ibm-styled-form','<%= commonprocess %>');
 		updateGeo("<%= geo %>");
	...
	<div id="ibm-leadspace-head" class="ibm-alternate">
		<div id="ibm-leadspace-body">
			...
			<h1>
				<%= messages.getString("device_modify_request") %>
			</h1>
		</div>
	</div>
...
<!-- CONTENT_BODY -->
	<div id="ibm-content-body">
		<div id="ibm-content-main">
			<!-- LEADSPACE_BEGIN -->
			<p>
				<%= messages.getString("device_modify_search_info") %>  <%= messages.getString("required_info") %>
			</p>
			...
			<div id='locform'>
				...
				<p><%= messages.getString("device_modify_by_location") %></p>
				<div class="pClass">
			...
			<div id="byname">
				...
				<div class="pClass">
					...
					<p><%= messages.getString("device_modify_by_name") %></p>
				</div>
				<div class="pClass">
		...
		<div id="ibm-content-sidebar">
			...
			<!--IBM Contact Module-->
				...
				<ul>
					<li><%= messages.getString("last_device_searched") %>: </li>
