...
public class UserInfo {
	...
	String employeeEmail = "not found"; //Employee email
	...
	String isMgr = "N";   //Is the employee a manager?
	...
	public UserInfo(String emailAddress) {
		...
		*/
		//System.out.println("This is the email address passed: __" + emailAddress + "__");
		 ...
		 */
		results = BluePages.getPersonsByInternet(emailAddress);
		...
		if (results.rows() == 0)
			...
			for (i = 0; i < results.rows(); i++) {
				...
				employeeEmail = (String) row.get("INTERNET");
	...
	public String empMgrSerial() {
		return empMgrSerial;
	} //end of public String empMgrSerial() 
	
	public String empMgrSerialCC() {
		return empMgrSerialCC;
	} //end of public String empMgrSerialCC()
	
	public String empTie() {
		return empTie;
	} //end of public String empTie()
	
	public String empXphone() {
		return empXphone;
	} //end of public String empXphone()
	
	public String empPager() {
		return empPager;
	} //end of public String empPager()
